...
### 2. 인증 API ✅
```bash
curl -u test123:Asdqwe123! http://localhost:8080/api/auth/check
# {"ok":true,"user":{...}}
```

### 3. 동영상 목록 API ✅
```bash
curl -u test123:Asdqwe123! http://localhost:8080/api/videos
